...
import 'package:upande_sensors/core/auth/auth_routes.dart';
import 'package:upande_sensors/core/context/tb_context.dart';
import 'package:upande_sensors/core/init/init_routes.dart';
import 'package:upande_sensors/modules/alarm/alarm_routes.dart';
import 'package:upande_sensors/modules/asset/asset_routes.dart';
import 'package:upande_sensors/modules/audit_log/audit_logs_routes.dart';
import 'package:upande_sensors/modules/customer/customer_routes.dart';
import 'package:upande_sensors/modules/dashboard/dashboard_routes.dart';
import 'package:upande_sensors/modules/device/device_routes.dart';
import 'package:upande_sensors/modules/home/home_routes.dart';
import 'package:upande_sensors/modules/profile/profile_routes.dart';
import 'package:upande_sensors/modules/tenant/tenant_routes.dart';
import 'package:upande_sensors/utils/ui_utils_routes.dart';
